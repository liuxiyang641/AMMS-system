        ...
        <b-card style="width: 50%;margin-left: 25%" no-body>
            ...
            <b-tabs card style="color: black">
                <b-tab title="个人用户注册" active>
                    <form class="ui form" id="individual-user-form">
                ...
                <b-tab title="单位账户注册">
                    <form class="ui form" ref="companyUserForm" id="company-user-form">
                        ...
                        <div class="inline required field">
                            ...
                            <div class="ui left pointing red basic label" style="display:none" ref="">
                                请选择稿件上传
                            </div>
                            <div class="ui left pointing red basic label"
                                v-if="relatedFile!==''"
                                style="display: inline-block;position: absolute">
                              {{this.relatedFile.name}}
                            </div>
                        </div>
        ...
        methods:{
            ...
            individualUserRegister:function () {
                ...
                axios.post('http://192.144.153.164:9000/individual/register',requestData).then(
                    (res)=>{
                        $('#individual-user-form .spinner').hide();
                        console.log(res);
                        if (res.data==='注册成功'){
                            $('#individual-user-form .ui.success.message').show();
                        }
                        else {
                            alert(res.data);
                        }
            ...
            companyUserRegister:function(){
                ...
                axios.post('http://192.144.153.164:9000/group/register', formData, config).then(
                    (res)=>{
                        $('#company-user-form .spinner').hide();
                        console.log(res.data);
                        if (res.data==='注册成功，请等待审核结果'){
                            $('#company-user-form .ui.success.message').show();
                        }
                    }
                ).catch((error) => {
                    console.log(error);
